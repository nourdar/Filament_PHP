@if ($settings?->telephone)
    ...
    <div class="fixed flex items-center justify-center h-5 bottom-28 right-5" style="z-index: 99999">
        <div x-data="{ open: false }">
            ...
            <div x-show="open" class="fixed inset-0 z-10 flex items-center justify-center px-2 overflow-hidden ">
                ...
                <div x-show="open" x-transition:enter="transition-transform ease-out duration-300"
                    ...
                    <!-- Modal Header -->
                    <div class="flex justify-center px-4 py-2 text-white bg-indigo-500">
                    ...
                    <div class="flex justify-end px-4 py-2 border-t">
                        <button x-on:click="open = false" aria-label="close the dialog button"
                            class="w-full px-3 py-1 text-white bg-indigo-500 rounded-md sm:w-auto"> اغلاق
                        </button>
                    </div>
                </div>
            </div>
