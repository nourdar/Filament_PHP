                ...
                <div class="px-3 md:px-0">
                    ...
                    <div class="w-full flex items-center py-4 mt-0">
                        @if ($settings?->facebook_page)
                            <!-- Facebook -->
                            <a href="{{ $settings?->facebook_page }}" class="mx-2">
                        ...
                        @if ($settings?->instagram_page)
                            <!-- Instagram -->
                            <a href="{{ $settings?->instagram_page }}" class="mx-2">
                                <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                                    <path
                        ...
                        @if ($settings?->pinterest_page)
                            <!-- Pinterest -->
                            <a href="{{ $settings?->pinterest_page }}" class="mx-2">
                                <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                                    <path
                        ...
                        @if ($settings?->twitter_page)
                            <!-- Twitter -->
                            <a href="{{ $settings?->twitter_page }}" class="mx-2">
                                <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                                    <path
