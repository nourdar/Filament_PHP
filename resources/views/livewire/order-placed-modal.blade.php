<div>
    ...
    <div role="success" >
        ...
        <div class="p-10 text-lg text-center text-green-700 border border-t-0 border-green-400 rounded-b">
      ...
      <div role="alert">
        ...
        <div class="p-10 text-lg text-center text-red-700 bg-red-100 border border-t-0 border-red-400 rounded-b">
